...
\begin{figure}[!h]
	\centering
	\input{tikz/segmentation/EdgeModelsRamp}
...
\subsubsection{Foundation\buchSeite{738}}
...
\end{enumerate}
\subsubsection{Multiple Thresholds\buchSeite{752}}
...
\paragraph{Using moving averages\buchSeite{759}}
...
\item Did two basins merge? $\rightarrow$ build dam.
\end{enumerate}
