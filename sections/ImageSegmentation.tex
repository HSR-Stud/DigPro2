...
\begin{equation}
	\nabla f = grad(f) = \left[\begin{array}{c} g_x \\ g_y \end{array}\right] =  \left[\displaystyle{\begin{array}{c} \frac{\delta f}{\delta x} \vspace{0.2cm}  \\ \frac{\delta f}{\delta y} \end{array}}\right] \notag
\end{equation}
...
%TODO Nummern 1 bis 5 Seite 75
%TODO Summary Otsu Seite 85
