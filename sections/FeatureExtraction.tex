...
\subsubsection{Other Polygonal Approximation Approaches\buchSeite{826}}
\paragraph{Merging} %TODO: not present in 4th edition?
...
\paragraph{Splitting} %TODO: not present in 4th edition?
...
\subsubsection{Boundary segments} %TODO: not present in 4th edition?
...
\paragraph{Structural approaches\buchSeite{851}}
...
Thus an image compression is possible by using only $k$ eigenvectors. The reconstructed image is then
	...
	\]
%TODO: rest of this chapter not covered in lessons
